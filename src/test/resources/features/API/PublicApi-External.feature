...
Feature: Public API
  ...
  Scenario: Search GET request to Public API with JSON response
    ...
    And I set the parameter API_KEY with value from properties file
    And I set the parameter INST_TOKEN with value from properties file
...
#BUG: EMBASE-12088
  ...
  Scenario: Search POST request to Public API with JSON response
    ...
    And I concatenate the request body with value from property 'apikey'
    And I concatenate the request body with value '&insttoken='
    And I concatenate the request body with value from property 'insttoken'
    And I concatenate the request body with value '&query=cancer'
